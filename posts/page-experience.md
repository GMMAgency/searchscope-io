...
Core Web Vitals and Lighthouse data use the same page set, so you can see technical health, indexation and performance together. That's useful because these problems rarely live in isolation.

Page Experience is live under Instruments. There's more on the [platform](/platform/) page.
