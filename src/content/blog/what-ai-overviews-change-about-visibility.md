...
So "position" has gone from a decent proxy to a leaky one. Optimising for it now can actively mislead you.
...
A model summarising the topic: are you the source it pulls from and attributes?
